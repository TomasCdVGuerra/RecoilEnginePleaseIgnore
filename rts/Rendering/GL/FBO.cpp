...
namespace
{
	...
	{
	public:
		LegacyTextureHandle(GLuint id, GLenum legacyTarget) : textureId(id),
															  target(legacyTarget),
	...
	static bool TryTranslateAttachmentPoint(GLenum attachment, gfx::AttachmentPoint &point)
	{
		if ((attachment >= GL_COLOR_ATTACHMENT0_EXT) && (attachment <= (GL_COLOR_ATTACHMENT0_EXT + 7)))
		{
			...
			{
			case 0u:
				point = gfx::AttachmentPoint::Color0;
				return true;
			case 1u:
				point = gfx::AttachmentPoint::Color1;
				return true;
			case 2u:
				point = gfx::AttachmentPoint::Color2;
				return true;
			case 3u:
				point = gfx::AttachmentPoint::Color3;
				return true;
			case 4u:
				point = gfx::AttachmentPoint::Color4;
				return true;
			case 5u:
				point = gfx::AttachmentPoint::Color5;
				return true;
			case 6u:
				point = gfx::AttachmentPoint::Color6;
				return true;
			case 7u:
				point = gfx::AttachmentPoint::Color7;
				return true;
			default:
				break;
			}
