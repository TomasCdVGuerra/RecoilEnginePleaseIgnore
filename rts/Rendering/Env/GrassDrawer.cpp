...
CGrassDrawer::CGrassDrawer()
	: CEventClient("[GrassDrawer]", 199992, false), blocksX(mapDims.mapx / grassSquareSize / grassBlockSize), blocksY(mapDims.mapy / grassSquareSize / grassBlockSize), grassDL(0), grassBladeTex(0), farTex(0), farnearVA(2048), grassOff(false), updateBillboards(false), updateVisibility(false)
{
