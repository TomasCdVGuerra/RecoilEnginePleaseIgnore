...
#ifdef __APPLE__
		myLog("StablePosAllocator<T>::Allocate(%u) = %u [thread_id = %" PRIuPTR "]", uint32_t(numElems), uint32_t(returnPos), reinterpret_cast<uintptr_t>(Threading::GetCurrentThreadId()));
#else
